...
class FrameProcessor():    
    ...
    def process_frame(self):
        ...
        self.original_frame = cv2.resize(self.original_frame, (1920, 1080), interpolation = cv2.INTER_CUBIC) #
        ...
        frame = cv2.resize(self.original_frame, (504, 322), 
        ...
        road_mask = np.load(f'/home/k64684/ultralytics/numpy_results_3/{frame_name}.npy')
        segmented_frame = np.load(f'/home/k64684/ultralytics/numpy_results_3/{frame_name}_segmented_frame.npy')
        ...
        points3D = np.load(f'/home/k64684/Depth-Anything-3/notebooks/depth_29frames_undistortion/{frame_name}.npy')
        #points3D = np.load(f'/home/k64684/Depth-Anything-3/notebooks/curve/{frame_name}.npy')
        #points3D = np.load("/home/k64684/Depth-Anything-3/notebooks/depth_29frames/1.npy")
        #points3D = points3D.reshape(-1, 3)
        #exit()
        #pcd = o3d.geometry.PointCloud()
        #pcd.points = o3d.utility.Vector3dVector(points3D)

        #o3d.io.write_point_cloud("picture_full_straight_line.ply", pcd)
        #exit()
        ...
        pcd = o3d.geometry.PointCloud()
        pcd.points = o3d.utility.Vector3dVector(road3D)

        o3d.io.write_point_cloud("road_with_outliers_straight_line.ply", pcd)
        #exit()
        ##################################################
        #print(road3D)
        print(road3D[2].min())
...
#####################################################
        ...
        o3d.io.write_point_cloud("road_without_outliers_straight_line.ply", pcd)
        #exit()
        ##########################
...
def main():
    ...
    parser.add_argument('--depth', type=float,
                        ...
                        default=7.5)   # from 7 meters (5.86667) to 9 meters (6.7) 
